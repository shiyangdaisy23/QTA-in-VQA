...
def main(params):
    ...
    train_anno = json.load(open('annotation/mscoco_train2014_annotations.json', 'r'))
    val_anno = json.load(open('annotation/mscoco_val2014_annotations.json', 'r'))
  
    train_ques = json.load(open('question/OpenEnded_mscoco_train2014_questions.json', 'r'))
    val_ques = json.load(open('question/OpenEnded_mscoco_val2014_questions.json', 'r'))
    test_ques = json.load(open('question/OpenEnded_mscoco_test-dev2015_questions.json', 'r'))
    subtype = 'train2014'
    ...
    for i in range(len(val_anno['annotations'])):
        ...
        val.append({'ques_id': question_id, 'img_path': image_path, 'question': question,'ans': ans})
